        ...
        try {
            ...
            if ($numero_registro != 0) {
                ...
                if(isset($_POST["recordar"])){
                    setcookie("nombreUsuario",$_POST["login"], time()+87000);
...
if($autenticado == false){
    if(!isset($_COOKIE["nombreUsuario"])){ // sino crea la cookie te muestra el formulario
        include("form.php");
    }
}
     ...
     echo "<div class='container'>
            ...
            <div>
                <div class='panel panel-default'>
                    <div class='panel-body'>
                        <div id='titulo' class='col-xs-12 col-md-6 col-md-offset-2'>
                            <p>";  echo 'Hola '  .$_POST['login'] .'!'; echo "</p>
                        </div>
                    </div>
                </div>
            </div>
